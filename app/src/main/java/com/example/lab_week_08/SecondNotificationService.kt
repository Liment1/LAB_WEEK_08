...
class SecondNotificationService : Service() {
    ...
    //Create a system handler which controls what thread the process is beingexecuted on
    ...
    override fun onCreate() {
        ...
        //'HandlerThread' provides the different thread for the process to beexecuted on,
        //while on the other hand, 'Handler' enqueues the process to HandlerThreadto be executed.
...
//"Build.VERSION_CODES.S" stands for 'S' which is the API 31 release name
    ...
    //therefore we need to check for the SDK version of the device.
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            //IMPORTANCE_HIGH - makes a sound, vibrates, appears as heads-upnotification
            //IMPORTANCE_DEFAULT - makes a sound but doesn't appear as heads-upnotification
    ...
    String) =
        NotificationCompat.Builder(this, channelId)
            ...
            //Sets the action/intent to be executed when the user clicks thenotification
            ...
            //If true, the notification is not dismissible and can only be closed bythe app
            .setOngoing(true)
...
//in your startForegroundService() custom function
    ...
    //A function to update the notification to display a count down from 10 to0
